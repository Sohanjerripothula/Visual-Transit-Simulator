...
public class LineTest {
  ...
  /**
   * Testing full branch coverage for the update function.
   */
  @Test
  public void testUpdateWithIssueBranchCoverage() {
    ...
    assertEquals(18, passenger.getWaitAtStop());
    assertEquals(true, testLine.isIssueExist());
  ...
  /**
   * Tests the isIssueExists function with a null issue.
   */
  @Test
  public void testIsIssueExistWithNullIssue() {
    Route mockInboundRoute = mock(Route.class);
    Route mockOutboudRoute = mock(Route.class);

    Line noIssueLine = new Line(1, "test", Line.BUS_LINE, mockInboundRoute, mockOutboudRoute, null);

    assertEquals(false, noIssueLine.isIssueExist());
  }
