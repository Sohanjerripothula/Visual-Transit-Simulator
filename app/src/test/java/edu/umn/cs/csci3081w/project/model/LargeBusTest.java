...
public class LargeBusTest {
   ...
   */
  @Test
  public void testReportOut() {
    Passenger testPassenger1 = new Passenger(1, "PassengerOne");
    Passenger testPassenger2 = new Passenger(2, "PassengerTwo");
    testBus.loadPassenger(testPassenger1);
    testBus.loadPassenger(testPassenger2);
    testBus.move();
    try {
      final Charset charset = StandardCharsets.UTF_8;
      ByteArrayOutputStream outputStream = new ByteArrayOutputStream();
      ...
      String strToCompare =
          "####Large Bus Info Start####" + System.lineSeparator()
              ...
              + "Name: PassengerTwo" + System.lineSeparator()
