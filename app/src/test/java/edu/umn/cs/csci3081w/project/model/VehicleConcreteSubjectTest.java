...
public class VehicleConcreteSubjectTest {
  ...
  public void testNotifyObservers() {
    ...
    JsonObject caputredJson = messageCaptor.getValue();

    String command = caputredJson.get("command").getAsString();
    String expectedCommand = "observedVehicle";
    assertEquals(expectedCommand, command);
    String observedText = caputredJson.get("text").getAsString();
  ...
  /**
   * Test the removal of the NotifyObserver.
   */
  @Test
