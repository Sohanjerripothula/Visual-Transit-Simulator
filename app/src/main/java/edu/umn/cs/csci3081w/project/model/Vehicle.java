...
public abstract class Vehicle implements VehicleObserver {
   ...
   * Constructor.
   * 
   * @param vehicle vehicle that is being created.
   */
  public Vehicle(Vehicle vehicle) {
    ...
    this.unloader = vehicle.unloader;
    this.passengers = new ArrayList<>(vehicle.passengers);
    this.distanceRemaining = vehicle.distanceRemaining;
    this.nextStop = vehicle.nextStop;
    this.setName(vehicle.getName());
    this.setPosition(new Position(vehicle.getPosition().getLongitude(),
                                  vehicle.getPosition().getLatitude()));
    this.carbonEmissionHistory = new ArrayList<>(vehicle.carbonEmissionHistory);
    this.red = vehicle.red;
    this.green = vehicle.green;
    this.blue = vehicle.blue;
    this.alpha = vehicle.alpha;
  }
